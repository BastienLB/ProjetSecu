...
\begin{document}
	...
	\end{center}
	 ...
	 D'un autre genre, une faille de sécurité a été découverte sur les frigos connectés Samsung permettant de récupérer des informations de comptes Gmail. Pour sécuriser ces informations, Samsung a mis en place un SSL, mais apparemment le matériel ne valider pas le certificat SSL, et donc les informations ont pu être dérobées.
